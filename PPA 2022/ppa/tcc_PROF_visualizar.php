	...
	<!-- SIDEBAR -->
		...
		<main>
			<div class="head-title">
				...
				<?php
					echo '<a href="tcc_encontros_PROF.php? matriculatcc='.$alunotcc->matriculatcc.'">Encontros</a>'
				?>
...
-->
						...
						<div class="teste2">
							...
							<select  readonly  class="teste3" name="id_curso" id="id_curso">
								...
								<label for="datainicio">Data de Inicio: </label> <input readonly class="enc"   class="enc" type="date" name="datainicio" value="<?php
								...
								<div class="encontro2">
								<label for="datadefesa">Previsão do Termino: </label> <input readonly class="enc"  type="date" name="datadefesa" value="<?php
								...
								<div class="encontro3">
							    <label for="dataconclusao">Data da Conclusão: </label> <input readonly class="enc"  type="date" name="dataconclusao" value="<?php
