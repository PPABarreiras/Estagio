                    ...
                    <div class="head">
                        ...
                        <?php
                            ...
                            foreach ($alunos as $aluno) {
                                ...
                                echo '<td><a href="' .$aluno->documento.'"> <img src="https://www.iconpacks.net/icons/2/free-pdf-file-icon-3382-thumb.png" alt=""> '.
                                
                                '</td>';
                                echo '<td> <a href="editarAluno_C.php? matricula='.$aluno->matricula.'">Editar</a></td>';
                                echo '<td> <a href="visualizarC.php? matricula='.$aluno->matricula.'">Visualizar</a></td>';
                            //echo '<td> <a href="anexoC.php? matricula='.$aluno->matricula.'">Anexar</a></td>';
