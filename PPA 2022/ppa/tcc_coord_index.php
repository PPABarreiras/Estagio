				...
				<div class="order">
					...
					<?php
                        ...
                        foreach ($alunostcc as $alunotcc) {
                            ...
                            '</td>';
                            echo '<td> <a href="editar_aluno_tcc.php? matriculatcc='.$alunotcc->matriculatcc.'">Editar</a></td>';
                            echo '<td> <a href="tcc_coord_visualizar.php? matriculatcc='.$alunotcc->matriculatcc.'">Visualizar</a></td>';
