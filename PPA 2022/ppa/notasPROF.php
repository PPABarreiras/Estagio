			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="indexPROF.php">Home</a>
						</li>
					</ul>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<div class="input6-box6">
										<input id="nota_relatorio" type="text" name="nota_relatorio" placeholder="Qual a nota?" required value="<?php
							...
							<tr>
								...
								<td>
									...
									<div class="input6-box6">
										<input id="nota_orientador" type="text" name="nota_orientador" placeholder="Qual a nota?" required value="<?php
							...
							<tr>
								...
								<td>
									...
									<div class="input6-box6">
										<input id="nota_empresa" type="text" name="nota_empresa" placeholder="Qual a nota?" required value="<?php
							...
							<tr>
								...
								<td>
									<div class="input6-box6">
										<input id="nota_aluno" type="text" name="nota_aluno" placeholder="Qual a nota?" required value="<?php
