				...
				<div class="order">
					<div class="head">
						...
						<form action="alunoHelper.php" method="POST">
							...
							<?php
							echo '<a href="notasC.php? matricula=' . $aluno->matricula . '">Resultado</a>'
							?>
					</div>
						...
						<div>
							...
							<div class="encontros">
								<div class="encontro1">
									...
									<label readonly for="encontro1">Encontro 1: </label> <input class="enc" type="date" name="encontro1" value="<?php
								...
								<div class="encontro2">
									<label readonly for="encontro2">Encontro 2: </label> <input class="enc" type="date" name="encontro2" value="<?php
								...
								<div class="encontro3">
									<label readonly for="encontro3">Encontro 3: </label> <input class="enc" type="date" name="encontro3" value="<?php
