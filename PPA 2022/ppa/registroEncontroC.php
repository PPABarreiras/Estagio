				...
				<div class="order">
					...
					<div>
						...
						<div>
							...
							<form action="encontrosHelper.php" method="POST">
							...
							<div class="encontros">
								<div class="encontro1">
									<label for="enconto1">1º encontro: </label> <input type="date" name="encontro1">
								</div>

								<div class="encontro2">
									<label for="enconto2">2º encontro: </label> <input type="date" name="encontro2">
								</div>

								<div class="encontro3">
									<label for="enconto3">3º encontro: </label> <input type="date" name="encontro3">
								</div>
							</form>
							</div>
